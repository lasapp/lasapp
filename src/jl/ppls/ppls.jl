...
function get_random_variable_node(::PPL, variable::VariableDefinition)::SyntaxNode
    error("Not implemented.")
end
...
function get_program_variable_node(ppl::PPL, variable::VariableDefinition)::SyntaxNode
    error("Not implemented.")
end

function get_program_variable_name(ppl::PPL, variable::VariableDefinition)::Symbol
    error("Not implemented.")
end
